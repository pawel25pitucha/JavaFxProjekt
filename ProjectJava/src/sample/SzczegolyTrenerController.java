...
public class SzczegolyTrenerController {
    @FXML
    ...
    pesel=TrenerzyController.getPesel();
    ResultSet rs = ConnectionDB.con.createStatement().executeQuery("SELECT * FROM Trener WHERE Pesel="+"'"+pesel+"'");
        while(rs.next()) {
