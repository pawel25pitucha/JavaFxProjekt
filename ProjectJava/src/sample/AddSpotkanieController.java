...
public class AddSpotkanieController {
    ...
    public void addSpotkanie(ActionEvent event){
        ...
        if(checkDane(punktyGosc,punktyGospodarz,finalCena,data1)){
    ...
    public boolean checkDane(String punkty1 , String punkty2,String cena,String data){
